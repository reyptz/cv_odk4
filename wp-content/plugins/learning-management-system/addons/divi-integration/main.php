	...
	add_action(
		...
		function() {
			printf(
				...
				esc_html( 'Masteriyo:' ),
				wp_kses_post( 'Divi Integration addon requires Divi theme to be installed and activated.', 'learning-management-system' ),
...
if ( ! Helper::is_divi_active() ) {
	add_filter(
		...
		function ( $result, $request, $controller ) {
			$result = __( 'Divi Theme should be installed and activated for this addon to work properly', 'learning-management-system' );
			return $result;
		},
		10,
		3
