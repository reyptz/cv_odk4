...
abstract class AbstractBlock {
	 ...
	 * @return mixed
	 */
	public function get_attribute( $attribute_key, $default_value = null ) {
		return blockart_array_get( $this->attributes, $attribute_key, $default_value );
	}
	...
	protected function get_default_html_attrs() {
		return [
			...
			'class' => $this->cn(
				"blockart-$this->block_name blockart-$this->block_name-{$this->get_attribute('clientId', '')}",
